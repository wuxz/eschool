                      ...
                      <form action="validateproject?<%=request.getQueryString()%>" method="post" name="projectadd" ONSUBMIT="return dosubmit()">
                          ...
                          <tr>
                            ...
                            <td valign="top">
                              ...
                              不公布
			      <input type="radio" name="state" value="考试完毕" <eschool:projectDetailsAttr attribute="checked_state_考试完毕"/>>
                              考试完毕</td>
                          </tr>
                          ...
                          <tr>
                            <td valign="top">成绩：</td>
                            <td valign="top">
                              <input type="radio" name="publishResult" value="公布" <eschool:projectDetailsAttr attribute="checked_publishresult_公布"/>>
                              公布
                              <input type="radio" name="publishResult" value="不公布" <eschool:projectDetailsAttr attribute="checked_publishresult_不公布"/>>
                              不公布</td>
                          </tr>

                          <tr>
                            <td valign="top">&nbsp;</td>
                            <td valign="top" align="center"><input type=image src="<%= request.getContextPath() %>/image/btn_save.gif" width="77" height="31" border="0"></td>
                          </tr>
                      </form>
	                  </eschool:projectDetails>
                        </table>
