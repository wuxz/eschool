...
public class DBConnectionManager {
    ...
    private void init() {
        ...
        InputStream is = getClass().getResourceAsStream("/com/dc/eschool/conf/database.properties");
        ...
        try {
            ...
            System.err.println("Can't read the properties file. " +
                "Make sure database.properties is in the CLASSPATH/conf/ ");
            return;
        }
