  ...
  <tr valign="top">
    ...
    <table width="600" border="0" cellspacing="0" cellpadding="0" align="center">
      <tr>
        ...
        <br><br>用户列表 <a href="usermanager?action=createUser">添加用户</a><br><br>
		      <table>
                          <tr>
                            <td>
                              <a href="users">学生</a>
                              <a href="users?value=teacher">教师</a>
                              <a href="users?value=admin">管理员</a>
                            </td>
                          </tr>
                        </table>
                          ...
                          <tr bgcolor="#CCCCCC">
                            ...
                            <eschool:items>
                              <tr>
                                ...
                                <td bgcolor="#FFFFFF"><a href="javascript:changepassword(<eschool:usersAttribute attribute="userID"/>)">修改密码</a></td>
                              </tr>
                            </eschool:items>
