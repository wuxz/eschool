...
<%
    ...
    String action = "studentprojectlist?type=" + type;
    if (request.getParameter("course") != null)
    	action += "&course=" + request.getParameter("course");
%>
...
function oncoursechange()
{
    ...
    window.document.location.href = 'studentprojectlist?type=<%=type%>' + coursestr;
}
</script>
                  ...
                  <table width="550" border="0" cellspacing="0" cellpadding="0" align="center">
                    ...
                    <tr>
                      <td valign="top">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td width="70"><a href="studentprojectlist?type=test"><img src="<%= request.getContextPath() %>/image/tab_exam_<%="test".equals(type) ? "active" : "normal"%>.gif" width="70" height="19" border="0"></a></td>
                            <td width="70"><a href="studentprojectlist?type=selfstudy"><img src="<%= request.getContextPath() %>/image/tab_selfstudy_<%="selfstudy".equals(type) ? "active" : "normal"%>.gif" width="70" height="19" border="0"></a></td>
                            <td width="70"><a href="studentprojectlist?type=exercise"><img src="<%= request.getContextPath() %>/image/tab_exercise_<%="exercise".equals(type) ? "active" : "normal"%>.gif" width="70" height="19" border="0"></a></td>
                            <td width="70"><a href="studentprojectlist?type=review"><img src="<%= request.getContextPath() %>/image/tab_review_<%="review".equals(type) ? "active" : "normal"%>.gif" width="70" height="19" border="0"></a></td>
                            <td width="70"><a href="studentprojectlist?type=selftest"><img src="<%= request.getContextPath() %>/image/tab_selftest_<%="selftest".equals(type) ? "active" : "normal"%>.gif" width="70" height="19" border="0"></a></td>
                            <td width="70"><a href="studentprojectlist?type=listening"><img src="<%= request.getContextPath() %>/image/tab_listening_<%="listening".equals(type) ? "active" : "normal"%>.gif" width="70" height="19" border="0"></a></td>
                            <td width="70"><a href="studentprojectlist?type=assignment"><img src="<%= request.getContextPath() %>/image/tab_task_<%="assignment".equals(type) ? "active" : "normal"%>.gif" width="70" height="19" border="0"></a></td>
                            <td width="70">&nbsp;</td>
                          </tr>
                        </table>
                      </td>
			  ...
			  <tr>
			    <td>
                          ...
                          <tr>
                            ...
                            <eschool:projectSearchList numItems='20' clause='<%=type%>' course='<%=request.getParameter("course")%>'>
                              <table border="0" cellspacing="1" cellpadding="2" width="160" align="right">
                                <tr>
                                  <eschool:firstForm action='studentprojectlist'>
                                  ...
                                  <eschool:prevForm action='studentprojectlist'>
                                  ...
                                  <eschool:nextForm action='studentprojectlist'>
                                  ...
                                  <eschool:lastForm action='studentprojectlist'>
				    ...
				    String urlString="";
                                    if ("test".equals(type))
                                    {
                                        urlString="studenttest";
                                    }
                                    else if ("assignment".equals(type))
                                    {
                                        urlString="studenthomework";
                                    }else
                                    {
                                        urlString="studentother";
                                    }
                                  %>

				  <eschool:items>
                                    <tr bgcolor="#f0f0f0">
                                      <td><a href="<%=urlString%>?projectId=<eschool:projectAttribute attribute="id"/>&type=<eschool:projectAttribute attribute="type"/>"><eschool:projectAttribute attribute="name"/></a></td>
