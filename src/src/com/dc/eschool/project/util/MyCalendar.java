...
public class MyCalendar implements java.io.Serializable
{
    ...
    private MyCalendar(int year, int month, int day, int hour, int min, int sec){
        this.month = month;
        this.day= day;
        this.year = year;
        this.hour = hour;
    ...
    public static MyCalendar getInstance(){
        ...
        return new MyCalendar(y,m,d,h,mm,s);
    }
    ...
    */
    ...
    {
        return (year +2000) + ((month + 1 < 10)? "0" : "") + (month + 1) + ((day < 10)? "0" : "") + day;
    }
