                  ...
                  <table width="550" border="0" cellspacing="0" cellpadding="0" align="center">
                    ...
                    <tr>
                      <td valign="top">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td width="70"><a href="t_item_list.jsp?project=test"><img src="/image/tab_exam_active.gif" width="70" height="19" border="0"></a></td>
                            <td width="70"><a href="t_item_list.jsp?project=selfschedule"><img src="/image/tab_selfstudy_normal.gif" width="70" height="19" border="0"></a></td>
                            <td width="70"><a href="t_item_list.jsp?project=exercise"><img src="/image/tab_exercise_normal.gif" width="70" height="19" border="0"></a></td>
                            <td width="70"><a href="t_item_list.jsp?project=review"><img src="/image/tab_review_normal.gif" width="70" height="19" border="0"></a></td>
                            <td width="70"><a href="t_item_list.jsp?project=selftest"><img src="/image/tab_selftest_normal.gif" width="70" height="19" border="0"></a></td>
                            <td width="70"><a href="t_item_list.jsp?project=listening"><img src="/image/tab_listening_normal.gif" width="70" height="19" border="0"></a></td>
                            <td width="70"><a href="t_item_list.jsp?project=assignment"><img src="/image/tab_task_normal.gif" width="70" height="19" border="0"></a></td>
                            <td width="70">&nbsp;</td>
                          </tr>
                        </table>
                      </td>
                          ...
                          <tr>
                            <td valign="top">
                              <table width="100%" border="0" cellspacing="1" cellpadding="2" bgcolor="#000000">
                                ...
                                <tr bgcolor="#FFFFFF">
                                  <td><a href="/teacher/test/t_test_detail.jsp?testId=9">期中考试</a></td>
                                  <td>09/01/2001</td>
                                  <td>一年级语文</td>
                                  <td>全校考试</td>
                                  <td>未考</td>
