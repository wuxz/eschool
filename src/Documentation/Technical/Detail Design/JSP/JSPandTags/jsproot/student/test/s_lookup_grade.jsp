                    ...
                    <tr>
                      ...
                      <td bgcolor="#E3EDEC" valign="top">
                        ...
                        <table width="98%" border="0" cellspacing="2" cellpadding="2" align="center">
                          ...
                          <tr>
                            <td valign="top">时间从</td>
                            <td valign="top">
                              <input type="text" name="textfield1">至<input type="text" name="textfield2">
                            </td>
                          </tr>
                          <tr>
                            <td valign="top">&nbsp;</td>
                            <td valign="top" align="center"><img src="/image/search_3.gif" width="68" height="22" border="0"></td>
                          </tr>
                        </table>
                        <br>
                        查询结果
