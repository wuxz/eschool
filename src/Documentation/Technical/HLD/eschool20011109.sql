...
CREATE TABLE "TestResultItem"(
    ...
    "AnswerNumber"        varchar(50)      NOT NULL,
    "Allow"               varchar(20)      DEFAULT '' NOT NULL,
    "CreateDate"          varchar(8)       DEFAULT '' NOT NULL,
    "CreateTime"          varchar(6)       DEFAULT '' NOT NULL,
    "CreateBy"            int              NOT NULL,
...
ALTER TABLE "StudentExamContent" ADD CONSTRAINT "StudentExamContent_CourseID_Course"
    FOREIGN KEY ("CourseID")
    REFERENCES "Course"("CourseID")
;

ALTER TABLE "StudentExamContent" ADD CONSTRAINT "StudentExamContent_ContentID_Content"
...
ALTER TABLE "ExaminationScore" ADD CONSTRAINT "ExaminationScore_TestResultItemID_TestResultItemID"
    FOREIGN KEY ("TestResultItemID")
    REFERENCES "TestResultItem"("TestResultItemID")
;
...
"Allow", "CreateDate", "CreateTime", "CreateBy", "LastModifyDate","LastModifyTime", "LastModifyBy") 
VALUES 
('auditor1', 'aud1', '旁听生1', '男', '20010914',
'010-65660182', 'dc@angelengineers.com.cn', '北京朝阳区东环南路2号 招商局大厦18F', '-1', '旁听', '正式',
'允许', '20010914', '111000', '-1', '20010914', '111000', '-1')
;
...
INSERT INTO "Class" 
("Name",  "Info", "Allow", "CreateDate", "CreateTime", "CreateBy", "LastModifyDate", "LastModifyTime", "LastModifyBy") 
VALUES 
('初一语文', '初一语文', '允许', '20010914', '111000', '1', '20010914', '111000', '1')
;
...
CREATE TABLE "Board" (
	...
	"BoardMaster" varchar(50),
	"MasterPwd" varchar(10),
	"MasterWord" varchar(50),
