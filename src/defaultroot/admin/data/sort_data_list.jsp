...
<table width="779" border="0" cellspacing="2" cellpadding="2">
  <tr valign="top">
    <td width="20">&nbsp;</td>
    <td width="160">
      <%@include file="/common/a_navigator.jsp" %>
    </td>
    <td>
                  ...
                  <table width="550" border="0" cellspacing="0" cellpadding="0" align="center">
                    ...
                    <tr>
                      <td valign="top">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td width="70"><a href="sort_data_list.jsp?project=test"><img src="<%= request.getContextPath() %>/image/tab_exam_active.gif" width="70" height="19" border="0"></a></td>
                            <td width="70"><a href="sort_data_list.jsp?project=selfschedule"><img src="<%= request.getContextPath() %>/image/tab_selfstudy_normal.gif" width="70" height="19" border="0"></a></td>
                            <td width="70"><a href="sort_data_list.jsp?project=exercise"><img src="<%= request.getContextPath() %>/image/tab_exercise_normal.gif" width="70" height="19" border="0"></a></td>
                            <td width="70"><a href="sort_data_list.jsp?project=review"><img src="<%= request.getContextPath() %>/image/tab_review_normal.gif" width="70" height="19" border="0"></a></td>
                            <td width="70"><a href="sort_data_list.jsp?project=selftest"><img src="<%= request.getContextPath() %>/image/tab_selftest_normal.gif" width="70" height="19" border="0"></a></td>
                            <td width="70"><a href="sort_data_list.jsp?project=listening"><img src="<%= request.getContextPath() %>/image/tab_listening_normal.gif" width="70" height="19" border="0"></a></td>
                            <td width="70"><a href="sort_data_list.jsp?project=assignment"><img src="<%= request.getContextPath() %>/image/tab_task_normal.gif" width="70" height="19" border="0"></a></td>
                            <td width="70">&nbsp;</td>
                          </tr>
                        </table>
                      </td>
