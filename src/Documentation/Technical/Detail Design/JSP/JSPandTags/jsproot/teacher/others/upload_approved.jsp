                  ...
                  <table width="564" border="0" cellspacing="0" cellpadding="0" align="center">
                    <tr>
                      ...
                      <td bgcolor="#E3EDEC" valign="top">
                        ...
                        <%@ include file="common/t_assignment_title.jsp" %>
                        <table width="92%" border="0" cellspacing="1" cellpadding="2" align="center">
                          <tr>
                            <td>
                              ...
                              <br>
                              <img src="/image/button_browse.gif" width="78" height="28">
                              <img src="/image/button_upload.gif" width="76" height="28"><br>
                              <br>
                              以下为您已经下发的资料<br>
                            </td>
                          </tr>
