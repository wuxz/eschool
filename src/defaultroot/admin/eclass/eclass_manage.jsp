...
<form action="validateneweclass?<%=request.getQueryString()%>" method="post" name="addclass" ONSUBMIT="return dosubmit()">
    ...
    <td>
      ...
      <table width="600" border="0" cellspacing="0" cellpadding="0" align="center">
        <tr>
          ...
          <eschool:eclassDetails>
            <table width="90%" align="center">
              <tr>
                <td width="30%" align="right">
                  <eschool:eclassDetailsAttr attribute="title"/>组
                </td>
                <td>&nbsp;
                </td>
              </tr>
              ...
              <tr>
                <td align="right">
                  ...
                  <td>
                  <input type="text" name="name" value="<eschool:eclassDetailsAttr attribute="Name"/>">
                  </td>
              </tr>
              <tr>
                <td align="right">
                  ...
                  <td>
                  <input type="text" name="info" value="<eschool:eclassDetailsAttr attribute="Info"/>">
                  </td>
              </tr>
              <tr>
                <td align="right">
              ...
              <tr>
                ...
                <td>
                  <input type="image" src="<%= request.getContextPath() %>/image/<eschool:eclassDetailsAttr attribute="button"/>_2.gif" width="68" height="22" name="submit" boder="0">
                </td>
              </tr>
            </table>
            </eschool:eclassDetails>
