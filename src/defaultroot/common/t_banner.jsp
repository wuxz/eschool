...
<table width="779" border="0" cellspacing="0" cellpadding="0" bgcolor="#409552">
  <tr valign="top">
    ...
    <td valign="middle" align="center" width="120"><a href="teacherinfo" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image34','','<%= request.getContextPath() %>/image/haead_personalnfo_active.gif',1)"><img name="Image34" border="0" src="<%= request.getContextPath() %>/image/haead_personalnfo_normal.gif" width="109" height="41"></a></td>
    <td valign="middle" align="center" width="120"><a href="projectlist?type=test" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image35','','<%= request.getContextPath() %>/image/haead_studyself_active.gif',1)"><img name="Image35" border="0" src="<%= request.getContextPath() %>/image/haead_studyself_normal.gif" width="109" height="41"></a></td>
