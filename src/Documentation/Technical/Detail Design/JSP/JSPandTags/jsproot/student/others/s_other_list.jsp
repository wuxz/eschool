                   ...
                   <table width="550" border="0" cellspacing="0" cellpadding="0" align="center">
                    ...
                    <tr>
                      <td valign="top">
                        <table width="100%"border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td width="61"><a href="s_other_detail.jsp"><img src="/image/info_detail_off.gif" width="61" height="19" border="0"></a></td>
                            <td width="61"><img src="/image/tab_subjectlist_active.gif" width="70" height="19" border="0"></td>
                            <td width="61">&nbsp;</td>
                            <td width="61">&nbsp;</td>
                            <td width="61">&nbsp;</td>
                            <td width="61">&nbsp;</td>
