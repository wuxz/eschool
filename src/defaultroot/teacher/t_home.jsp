                                  ...
                                  <td valign="top">
                                    <table width="100%" border="0" cellspacing="0" cellpadding="3">
                                      ...
                                      <tr bgcolor="#efefef">
                                        <td>&nbsp;</td>
                                        <td>&nbsp;</td>
                                        <td><a href="tcourseinfo?method=teacher">更多&nbsp;&gt;&gt;</a></td>
                                      </tr>
                                    </table>
                                  </td>
                            ...
                            <td valign="top">
                              <table width="100%" border="0" cellspacing="0" cellpadding="0">
		                        ...
		                        <eschool:projectSearchList numItems="5" clause="test" emptyString="">
			                      <eschool:items>
                                            <tr bgcolor="#efefef">
                                              <td><a href="testmanager?action=updateproject&projectId=<eschool:projectAttribute attribute="id"/>&type=<eschool:projectAttribute attribute="type"/>"><eschool:projectAttribute attribute="name"/></a></td>
                                      ...
                                      <tr bgcolor="#efefef">
                                        <td>&nbsp;</td>
                                        <td>&nbsp;</td>
                                        <td><a href="projectlist?type=test">更多&nbsp;&gt;&gt;</a></td>
                                      </tr>
                                    </table>
                                  </td>
                                  ...
                                  <td valign="top">
                                    <table width="100%" border="0" cellspacing="0" cellpadding="3">
                                      ...
                                      <eschool:projectSearchList numItems="5" clause="assignment" emptyString="">
                                        <eschool:items>
                                          <tr bgcolor="#efefef">
                                            <td><a href="othermanager?action=updateproject&projectId=<eschool:projectAttribute attribute="id"/>&type=<eschool:projectAttribute attribute="type"/>"><eschool:projectAttribute attribute="name"/></a></td>
                                            <td><eschool:projectAttribute attribute="startdate"/></td>
                                            <td><eschool:projectAttribute attribute="coursename"/></td>
                                          </tr>
                                        </eschool:items>
                                      ...
                                      <tr bgcolor="#efefef">
                                        <td>&nbsp;</td>
                                        <td>&nbsp;</td>
                                        <td><a href="projectlist?type=assignment">更多&nbsp;&gt;&gt;</a></td>
                                      </tr>
                                    </table>
                                  </td>
                                  ...
                                  <td valign="top">
                                    <table width="100%" border="0" cellspacing="0" cellpadding="3">
                                      ...
                                      <tr bgcolor="#efefef">
                                        <td>&nbsp;</td>
                                        <td>&nbsp;</td>
                                        <td><a href="projectlist?type=listening">更多&nbsp;&gt;&gt;</a></td>
                                      </tr>
                                    </table>
                                  </td>
                          ...
                          <tr>
			                ...
			                <eschool:items>
                                      ...
                                      <tr bgcolor="#efefef">
                                        <td>&nbsp;</td>
                                        <td>&nbsp;</td>
                                        <td><a href="projectlist?type=selfstudy">更多&nbsp;&gt;&gt;</a></td>
                                      </tr>
                                    </table>
                                  </td>
                                  <td align="right" width="4" valign="top"><img src="<%= request.getContextPath() %>/image/content_dot_4.gif" width="4" height="22"></td>
